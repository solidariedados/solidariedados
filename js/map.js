...
setTimeout(() => {
  ...
  const ICON_TIKTOK = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>`;
  ...
  window.LOCATIONS.forEach((location, index) => {
    ...
    if (location.tiktok) {
      socialLinks.push(`<a href="https://www.tiktok.com/@${location.tiktok}" target="_blank" rel="noopener noreferrer" class="social-btn social-tiktok" title="TikTok @${location.tiktok}">${ICON_TIKTOK}</a>`);
    }
    if (location.discord) {
    ...
    const ICON_KEYWORDS = { instagram: ICON_INSTAGRAM, tiktok: ICON_TIKTOK, discord: ICON_DISCORD, twitch: ICON_TWITCH, youtube: ICON_YOUTUBE, website: ICON_WEBSITE, maps: ICON_MAPS };
